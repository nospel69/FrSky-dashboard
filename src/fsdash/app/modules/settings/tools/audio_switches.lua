...
local function openPage(pageIdx, title, script)
    ...
    dashx.app.ui.fieldHeader("Settings" .. " / " .. "Audio" .. " / " .. "Switches")
    ...
    for i, v in ipairs(sensorList) do
        ...
        dashx.app.formFields[formFieldCount] = form.addSwitchField(dashx.app.formLines[dashx.session.formLineCnt], nil, function()
...
local function onNavMenu()
    ...
    dashx.app.ui.openPage(pageIdx, "Settings", "settings/tools/audio.lua")
end
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(settings) do dashx.preferences.switches[key] = value end
