...
local S_PAGES = {
    {name = "General", script = "general.lua", image = "general.png"}, {name = "Dashboard", script = "dashboard.lua", image = "dashboard.png"},
    {name = "Localization", script = "localizations.lua", image = "localizations.png"}, {name = "Audio", script = "audio.lua", image = "audio.png"},
    {name = "Development", script = "development.lua", image = "development.png"}
}
