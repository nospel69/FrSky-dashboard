...
function render.wakeup(box)
    ...
    box._dyn = {pitch = smooth((box._dyn and box._dyn.pitch), pitch), roll = smooth((box._dyn and box._dyn.roll), roll), yaw = smooth((box._dyn and box._dyn.yaw), yaw), altitude = altitude, groundspeed = groundspeed}
end
